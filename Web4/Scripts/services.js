angular.module('app.services', []).
   ...
   service('$menuItems', function () {
      ...
      this.prepareRetailMenu = function () {
          var retail = this.addItem('Lens.care Admin', '/retail', 'linecons-desktop');
          retail.addItem('Reviews', '/reviews');
          retail.addItem('Promotions', '/promos');
           var invoices = retail.addItem('Invoices', '/inv');
          invoices.addItem('Ship / Print', '/invoices');
          invoices.addItem('Refunds and Returns', '/returns');
          

          var web_content = retail.addItem('Web Content', '/webcontent');
          web_content.addItem('Page Content Editor', '/webinfo');
          web_content.addItem('Pages', '/webpage');
          return this;

      };
      this.prepareSalesMenu = function () {


       

       
          var sales = this.addItem('Sales Team', '/sales', 'linecons-desktop');

         //  var sales_list = sales.addItem('Customers List', '/customers-list', 'fa-user');
           var sales_menu = sales.addItem('Customer Info +Notes', '/customers-find', 'fa-pencil-square-o');
           var sales_mileage = sales.addItem('Mileage *Quick', '/sales-mileage', 'fa-automobile');
           sales_mileage.addItem("Report");
           sales_mileage.addItem("Mileage", 'sales-mileage', '')
           var sales_addcustomer = sales.addItem('Customer Prospects', '/customer-prospects', 'fa-users');

           var reports_menu = sales.addItem('Reports', '/admin/reports', 'fa-line-chart');
           reports_menu.addItem('Mileage Report', '/admin/reports/mileagereport');

        //  sales_menu.addItem('Customer list', '/customers-list');
        //  var customer_info = sales_menu.addItem('ECP Setup', '/customers-retailsignup');
        //  var customer_sales = sales_menu.addItem('Customer SnapShot', '/customer-snapshot');
          return this;
      };
      this.prepareAdminMenu = function () {
          var admin = this.addItem('Optik Admin', '/admin', 'linecons-cog');


          var reports_menu = admin.addItem('Reports', '/admin/reports', 'fa-line-chart');
          reports_menu.addItem('Mileage Report', '/admin/reports/mileagereport');

          var admin_orders = admin.addItem('Client Orders', '/admin/orders', 'fa-shopping-basket');
          admin_orders.addItem('Order Glasses', '/admin/orders/glasses','fa-glasses');
          admin_orders.addItem('Order Lenses', '/admin/orders/lenses');

          return this;
      };

      this.prepareSidebarMenu = function () {
          this.prepareSalesMenu();
          this.prepareAdminMenu();
          this.prepareRetailMenu();
          //var dashboard    = this.addItem('Dashboard', 		'/app/dashboard', 			'linecons-cog');
          //var retail            = this.addItem('Retail Admin', '/retail', 'linecons-desktop');
          //var admin = this.addItem('Optik Admin', '/admin', 'linecons-cog');
          //var sales = this.addItem('Retail Sales', '/sales', 'linecons-desktop');
          ...
          //Subitems of Orders
         // admin.addItem('Client Orders', '/admin/orders');
      ...
      this.setActive = function (path) {
          this.iterateCheck(this.menuItems, path);
      };
